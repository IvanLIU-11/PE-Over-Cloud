...
class AthleteInfoPage extends StatefulWidget {
  const AthleteInfoPage({super.key});

  @override
  State<AthleteInfoPage> createState() => _AthleteInfoPageState();
}
...
class _AthleteInfoPageState extends State<AthleteInfoPage> {
  ...
  bool _isFirstGrade = true;
  bool _isSecondGrade = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: AppBar(
              title: PEOCText.easyText(text: "运动员注册", fontsize: 20.sp),
              centerTitle: true,
                  ...
                  child: ListView(
                    children: [
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.fromLTRB(_leftPadding, 0, 0, 0),
                        child:
                            PEOCText.easyText(text: "运动员归属地", fontsize: 14.sp),
                      ),
                                ...
                                onTap: () {
                                  ...
                                  onTapPickPicture(context, 1)
                                    ...
                                    if (chooseImagesPath != null) {
                                      setState(() {
                                        _isUploadPhoto = true;
                                        _photoPath = chooseImagesPath[0];
                                      });
                                    }
                                  });
                                },
                                //根据是否上传图片改变显示内容，上传了就显示图片
                                child: _isUploadPhoto
                                    ? SizedBox(
                                        width: 330.w,
                                        height: 195.h,
                                        child: Stack(
